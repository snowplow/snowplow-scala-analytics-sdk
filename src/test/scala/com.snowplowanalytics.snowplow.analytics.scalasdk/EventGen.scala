...
object EventGen {
  ...
  val event: Gen[Event] =
    for {
      app_id <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("app_id", Int.MaxValue), Gen.alphaNumChar))
      ...
      name_tracker <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("name_tracker", Int.MaxValue), Gen.alphaNumChar))
      ...
      geo_country <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("geo_country", Int.MaxValue), Gen.alphaUpperChar))
      geo_region <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("geo_region", Int.MaxValue), Gen.alphaNumChar))
      geo_city <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("geo_city", Int.MaxValue), Gen.alphaChar))
      geo_zipcode <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("geo_zipcode", Int.MaxValue), Gen.alphaNumChar))
      geo_latitude <- Gen.option(Arbitrary.arbitrary[Double])
      geo_longitude <- Gen.option(Arbitrary.arbitrary[Double])
      geo_region_name <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("geo_region_name", Int.MaxValue), Gen.alphaChar))
      ip_isp <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("ip_isp", Int.MaxValue), Gen.alphaNumChar))
      ip_organization <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("ip_organization", Int.MaxValue), Gen.alphaNumChar))
      ip_domain <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("ip_domain", Int.MaxValue), Gen.alphaNumChar))
      ip_netspeed <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("ip_netspeed", Int.MaxValue), Gen.alphaNumChar))
      ...
      page_urlhost <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("page_urlhost", Int.MaxValue), Gen.alphaNumChar))
      ...
      refr_urlfragment <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("refr_urlfragment", Int.MaxValue), Gen.alphaNumChar))
      refr_medium <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("refr_medium", Int.MaxValue), Gen.alphaNumChar))
      ...
      mkt_campaign <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("mkt_campaign", Int.MaxValue), Gen.alphaNumChar))
      ...
      se_action <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("se_action", Int.MaxValue), Gen.alphaNumChar))
      ...
      tr_affiliation <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("tr_affiliation", Int.MaxValue), Gen.alphaNumChar))
      ...
      tr_country <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("tr_country", Int.MaxValue), Gen.alphaNumChar))
      ...
      useragent <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("useragent", Int.MaxValue), Gen.alphaNumChar))
      ...
      br_version <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("br_version", Int.MaxValue), Gen.alphaNumChar))
      ...
      dvce_type <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("dvce_type", Int.MaxValue), Gen.alphaNumChar))
      ...
      tr_currency <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("tr_currency", Int.MaxValue), Gen.alphaNumChar))
      ...
      event_fingerprint <- Gen.option(strGen(Event.FIELD_SIZES.getOrElse("event_fingerprint", Int.MaxValue), Gen.alphaNumChar))
