...
class EventSpec extends Specification {
  ...
  "The Event parser" should {
    ...
    "return correct results from helper methods" in {
      ...
      event.contexts.toJson mustEqual Map(
      ...
      event.derived_contexts.toJson mustEqual Map(
      ...
      event.unstruct_event.toJson must beSome(
  ...
  "The transformSchema method" should {
    "successfully convert schemas into snake_case" in {
      SnowplowEvent.transformSchema("contexts", "org.w3", "PerformanceTiming", 1) mustEqual "contexts_org_w3_performance_timing_1"
      SnowplowEvent.transformSchema("contexts", SchemaKey("org.w3", "PerformanceTiming", "jsonschema", SchemaVer.Full(1, 0, 0))) mustEqual "contexts_org_w3_performance_timing_1"
      SnowplowEvent.transformSchema("contexts", "com.snowplowanalytics.snowplow", "ua_parser_context", 1) mustEqual "contexts_com_snowplowanalytics_snowplow_ua_parser_context_1"
      SnowplowEvent.transformSchema("unstruct_event", "com.snowplowanalytics.self-desc", "schema", 1) mustEqual "unstruct_event_com_snowplowanalytics_self_desc_schema_1"
    }
  }
}
