...
// iglu
import com.snowplowanalytics.iglu.core.{ ParseError, SelfDescribingData, SchemaKey }
import com.snowplowanalytics.iglu.core.circe.instances._

// circe
import io.circe.{ Decoder, DecodingFailure, Json, JsonObject, Error }
import io.circe.parser.{ parse => parseJson }

// This library
import Common.{ ContextsCriterion, UnstructEventCriterion }
import SnowplowEvent.{ Contexts, UnstructEvent }
